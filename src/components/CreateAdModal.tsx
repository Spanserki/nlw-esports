      ...
      async function handleCreateAd(event: FormEvent) {
        ...
        try {
           await axios.post(`http://localhost:3000/games/${data.game}/ads`, {
                ...
                name: data.name,
                yersPlaying: Number(data.yearsPlaying),
            ...
            <form onSubmit={handleCreateAd} className='mt-8 flex flex-col gap-4'>
              <div className='flex flex-col gap-2'>
               ...
               <select 
                    id='name' 
                    name='game'
                    className='bg-zinc-900 py-3 px-4 rounded text-sm placeholder:text-zinc-500 focus: outline-none'
               >
              ...
              <div className='grid grid-cols-2 gap-6'>
                <div className='flex flex-col gap-2'>
                  ...
                  <Input name='yearsPlaying' id='yearsPlaying' type="number" placeholder="Tudo bem ser nivel o" />
                </div>
